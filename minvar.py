...
tickers = st.multiselect('Select tickers', ('^FTSE', '^GSPC', '^DJI', '^IXIC', '^GDAXI', '^FCHI', '^N225', '^HSI', '000001.SS', '399001.SZ', '^AXJO', '^GSPTSE', '^JN0U.JO', '^RUT', '^VIX', '^STOXX50E', '^N100', '^BFX', 'IMOEX.ME', '^NYA', '^XAX', '^STI', '^AORD', '^BSESN', '^JKSE', '^KLSE', '^NZ50', '^KS11', '^TWII', '^BVSP', '^MXX', '^IPSA', '^MERV', '^TA125.TA', '^CASE30', '^NSEI'))
